...
const features = [
  ...
  },
  {
    ...
    description: 'Equipped with its own phone number and accounts to call, text, and join meetings on any platform.',
    icon: (
      <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Each Digital Employee is powered by a specialized swarm of AI agents to ensure expert-level performance.',
    icon: (
      <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
